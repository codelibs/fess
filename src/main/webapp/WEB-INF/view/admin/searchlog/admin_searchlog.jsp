                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <la:form action="/admin/searchlog/">
                                ...
                                <div class="form-group row">
                                    <label for="queryIdSearch" class="col-sm-2 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="userSessionIdSearch" class="col-sm-2 col-form-label"><la:message
                                ...
                                <c:if test="${logType == 'search'}">
                                    <div class="form-group row">
                                        <label for="accessTypeSearch" class="col-sm-2 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="requestedTimeRangeSearch" class="col-sm-2 col-form-label"><la:message
