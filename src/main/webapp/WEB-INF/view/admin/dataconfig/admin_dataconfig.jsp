                ...
                <div class="fads-col-md-12">
                    <div class="fads-card">
                        ...
                        <div class="fads-card-body">
                            ...
                            <div class="collapse <c:if test="${!empty name || !empty handlerName || !empty description}">show</c:if>" id="listSearchForm">
                            ...
                            <c:if test="${dataConfigPager.allRecordCount > 0}">
                                <div class="fads-row top10">
                                    <div class="fads-col-sm-12">
                                        <table class="fads-table" aria-label="<la:message key="labels.data_config_list" />">
                                            <thead>
                                            <tr>
