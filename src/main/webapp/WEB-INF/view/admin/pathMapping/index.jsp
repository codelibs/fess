			...
			<div>
				<ul class="pills">
					<li class="active"><a href="#"><bean:message
								key="labels.path_mapping_link_list" /></a></li>
						...
						<c:forEach var="data" varStatus="s" items="${pathMappingItems}">
							<tr class="${s.index % 2 == 0 ? 'row1' : 'row2'}">
								...
								<td style="text-align: center;"><s:link
										...
										<bean:message key="labels.path_mapping_link_details" />
									</s:link> <s:link href="editpage/2/${f:u(data.id)}">
										<bean:message key="labels.path_mapping_link_edit" />
					...
					<div class="pagination">
						<ul>
							...
							<c:forEach var="p" varStatus="s"
								...
								<li
									<c:if test="${p == pathMappingPager.currentPageNumber}">class="active"</c:if>>
