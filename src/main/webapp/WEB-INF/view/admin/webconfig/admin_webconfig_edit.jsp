...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <la:form action="/admin/webconfig/" styleClass="form-horizontal">
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="urls" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="includedUrls" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="excludedUrls" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="includedDocUrls" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="excludedDocUrls" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="configParameter" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="numOfThread" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="intervalTime" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row"<c:if
                                    ...
                                    <label for="labelTypeIds" class="col-sm-3 col-form-label"><la:message
