                ...
                <div class="fads-col-md-12">
                    <div class="fads-card">
                        ...
                        <div class="fads-card-body">
                            ...
                            <div class="collapse <c:if test="${!empty name || !empty urls || !empty description}">show</c:if>" id="listSearchForm">
                                <la:form action="/admin/webconfig/">
                                    ...
                                    <div class="fads-form-field">
                                        ...
                                        <div class="col-sm-10">
                                            <la:text styleId="urls" property="urls" styleClass="fads-textfield"/>
                                        </div>
                                    </div>
                                    <div class="fads-form-field">
                            ...
                            <c:if test="${webConfigPager.allRecordCount > 0}">
                                <div class="fads-row top10">
                                    <div class="fads-col-sm-12">
                                        <table class="fads-table" aria-label="<la:message key="labels.web_config_list" />">
                                            <thead>
                                            <tr>
                                                <th><la:message key="labels.name"/></th>
                                                <th class="fads-text-center" style="width: 20%"><la:message
                                            ...
                                            <c:forEach var="data" varStatus="s"
                                                ...
                                                <tr
                                                        data-href="${contextPath}/admin/webconfig/details/4/${f:u(data.id)}" role="button" tabindex="0">
                                                    <td>${f:h(data.name)}</td>
                                                    <td class="fads-text-center"><c:if
