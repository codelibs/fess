		...
		<div class="list-table">
			<div>
				<ul class="pills">
					<li class="active"><a href="#"><bean:message
								key="labels.scheduledjob_link_list" /></a></li>
			...
			<c:if test="${scheduledJobPager.allRecordCount > 0}">
				<table class="bordered-table zebra-striped">
					<thead>
						<tr>
							<th style="text-align: center;"><bean:message key="labels.scheduledjob_name" /></th>
							<th style="text-align: center;"><bean:message key="labels.scheduledjob_status" /></th>
							<th style="text-align: center;"><bean:message key="labels.scheduledjob_target" /></th>
							<th style="text-align: center;"><bean:message key="labels.scheduledjob_cronExpression" /></th>
						...
						<c:forEach var="data" varStatus="s" items="${scheduledJobItems}">
							<tr class="${s.index % 2 == 0 ? 'row1' : 'row2'}">
								...
								<td style="text-align: center;"><s:link
										...
										<bean:message key="labels.scheduledjob_link_details" />
									</s:link> <s:link href="editpage/2/${f:u(data.id)}">
										<bean:message key="labels.scheduledjob_link_edit" />
					...
					<div class="pagination">
						<ul>
							...
							<c:forEach var="p" varStatus="s"
								...
								<li
									<c:if test="${p == scheduledJobPager.currentPageNumber}">class="active"</c:if>>
