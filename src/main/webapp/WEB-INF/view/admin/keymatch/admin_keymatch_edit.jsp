                        ...
                        <div
                            ...
                            <div class="fads-card-body">
                                ...
                                <div class="fads-form-field">
                                    <label for="term" class="fads-label"><la:message
                                ...
                                <div class="fads-form-field">
                                    <label for="query" class="fads-label"><la:message
                                            key="labels.key_match_query"/></label>
                                    <div class="fads-col-sm-9">
                                        <la:errors property="query"/>
                                        <la:text styleId="query" property="query" styleClass="fads-textfield"/>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                    <label for="maxSize" class="fads-label"><la:message
                                            key="labels.key_match_size"/></label>
                                    <div class="form-inline col-sm-9">
                                        <la:errors property="maxSize"/>
                                        <input type="number" name="maxSize" id="maxSize"
                                               value="${f:h(maxSize)}" class="fads-textfield"
                                               min="0" max="10000000">
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                ...
                                <div class="fads-form-field">
                                    <label for="virtualHost" class="fads-label"><la:message
