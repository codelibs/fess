<%@page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><tiles:insert template="/WEB-INF/view/common/admin/layout.jsp" flush="true">
	...
	<tiles:put name="body" type="string">
        ...
        <h3><bean:message key="labels.file_crawling_title_details"/></h3>
...
<html:hidden property="sortOrder"/>
		<table class="bordered-table zebra-striped" style="width:500px;">
            <tbody>
                    ...
                    <td><html:textarea property="paths" style="width:345px;" rows="5"/></td>
                </tr>
					                <tr>
                    <th style="width:150px;"><bean:message key="labels.included_paths"/></th>
                    <td><html:textarea property="includedPaths" style="width:345px;" rows="5"/></td>
                </tr>
					                <tr>
                    <th style="width:150px;"><bean:message key="labels.excluded_paths"/></th>
                    <td><html:textarea property="excludedPaths" style="width:345px;" rows="5"/></td>
                </tr>
					                <tr>
                    <th style="width:150px;"><bean:message key="labels.included_doc_paths"/></th>
                    <td><html:textarea property="includedDocPaths" style="width:345px;" rows="5"/></td>
                </tr>
					                <tr>
                    <th style="width:150px;"><bean:message key="labels.excluded_doc_paths"/></th>
                    <td><html:textarea property="excludedDocPaths" style="width:345px;" rows="5"/></td>
                </tr>
						<tr>
                    ...
                    <td><html:text property="intervalTime" size="6"/><bean:message key="labels.millisec"/></td>
                </tr>
					                <tr>
                ...
                <tr>
                	...
                	<td>
<html:select property="roleTypeIds" multiple="true" size="5" style="width:345px;">
<c:forEach var="rt" varStatus="s" items="${roleTypeItems}">
	<html:option value="${f:u(rt.id)}">${f:h(rt.name)}</html:option>
                ...
                <tr>
                	...
                	<td>
<html:select property="labelTypeIds" multiple="true" size="5" style="width:345px;">
<c:forEach var="l" varStatus="s" items="${labelTypeItems}">
	<html:option value="${f:u(l.id)}">${f:h(l.name)}</html:option>
				...
				<tr>
                    ...
                    <td>
						<html:select property="available">
							<html:option value="T"><bean:message key="labels.enabled"/></html:option>
							<html:option value="F"><bean:message key="labels.disabled"/></html:option>
						</html:select>
					</td>
                </tr>
