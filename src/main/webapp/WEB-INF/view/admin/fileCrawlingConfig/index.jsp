<%@page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><tiles:insert template="/WEB-INF/view/common/admin/layout.jsp"
	...
	<tiles:put name="body" type="string">
		...
		<div class="list-table">
			...
			<c:if test="${fileCrawlingConfigPager.allRecordCount == 0}">
				...
				<div class="row center">
					<div id="subfooter" class="pagination">
						<ul>
							...
							<c:forEach var="p" varStatus="s"
								items="${fileCrawlingConfigPager.pageNumberList}">
								<li
									<c:if test="${p == fileCrawlingConfigPager.currentPageNumber}">class="active"</c:if>>
					...
					<div>
						<span><bean:message key="labels.pagination_page_guide_msg"
								arg0="${f:h(fileCrawlingConfigPager.currentPageNumber)}"
								arg1="${f:h(fileCrawlingConfigPager.allPageCount)}"
								arg2="${f:h(fileCrawlingConfigPager.allRecordCount)}" /></span>
					</div>
				</div>
			</c:if>
			<%-- Page Navigation: END --%>
