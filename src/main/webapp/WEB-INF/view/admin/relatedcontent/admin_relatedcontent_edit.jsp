                    ...
                    <div class="fads-col-md-12">
                        <div
                            ...
                            <div class="fads-card-body">
                                ...
                                <div class="fads-form-field">
                                    <label for="content" class="fads-label"><la:message
                                            key="labels.related_content_content"/></label>
                                    <div class="fads-col-sm-9">
                                        <la:errors property="content"/>
                                        <la:textarea styleId="content" property="content" styleClass="fads-textfield"
                                                     rows="5"/>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                    ...
                                    <div class="fads-col-sm-9">
                                        ...
                                        <la:text styleId="sortOrder" property="sortOrder" styleClass="fads-textfield"/>
                                    </div>
                                </div>
                                <div class="fads-form-field">
