							...
							<div class="box">
								...
								<div class="box-header with-border">
									<h3 class="box-title">
										...
										<c:if test="${crudMode == 4}">
											<bean:message key="labels.key_match_link_confirm" />
										</c:if>
									</h3>
								...
								<div class="box-body">
									...
									<table class="table table-bordered">
										<tbody>
											<tr>
												<th class="col-xs-2"><bean:message key="labels.key_match_term" /></th>
								...
								<div class="box-footer">
									<c:if test="${crudMode == 1}">
										<input type="submit" class="btn" name="editagain" value="<bean:message key="labels.key_match_button_back"/>" />
									...
									<c:if test="${crudMode == 2}">
										...
										<input type="submit" class="btn btn-primary" name="update"
											value="<bean:message key="labels.key_match_button_update"/>"
										/>
									</c:if>
									<c:if test="${crudMode == 3}">
										...
										<input type="submit" class="btn btn-primary" name="delete"
											value="<bean:message key="labels.key_match_button_delete"/>"
										/>
									</c:if>
									<c:if test="${crudMode == 4}">
										<input type="submit" class="btn" name="back" value="<bean:message key="labels.key_match_button_back"/>" />
										<input type="submit" class="btn" name="editfromconfirm"
											value="<bean:message key="labels.key_match_button_edit"/>"
										/>
