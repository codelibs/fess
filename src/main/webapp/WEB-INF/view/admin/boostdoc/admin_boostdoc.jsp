                    ...
                    <div class="fads-card">
                        ...
                        <div class="fads-card-body">
                            ...
                            <div class="collapse <c:if test="${!empty urlExpr || !empty boostExpr}">show</c:if>" id="listSearchForm">
                                <la:form action="/admin/boostdoc/">
                                    <div class="fads-form-field">
                                        ...
                                        <div class="col-sm-10">
                                            <la:text styleId="urlExpr" property="urlExpr" styleClass="fads-textfield"/>
                                        </div>
                                    </div>
                                    <div class="fads-form-field">
                            ...
                            <c:if test="${boostDocPager.allRecordCount > 0}">
                                <div class="fads-row top10">
                                    <div class="fads-col-sm-12">
                                        <table class="fads-table" aria-label="<la:message key="labels.boost_document_rule_list" />">
                                            <thead>
                                            <tr>
                                                <th><la:message
                                            ...
                                            <c:forEach var="data" varStatus="s"
                                                ...
                                                <tr
                                                        data-href="${contextPath}/admin/boostdoc/details/4/${f:u(data.id)}" role="button" tabindex="0">
