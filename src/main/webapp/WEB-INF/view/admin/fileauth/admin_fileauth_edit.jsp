                        ...
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="hostname" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="port" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="protocolScheme" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="username" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="parameters" class="col-sm-3 col-form-label"><la:message
                                ...
                                <div class="form-group row">
                                    <label for="fileConfigId" class="col-sm-3 col-form-label"><la:message
