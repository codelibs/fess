							...
							<div class="box">
								...
								<div class="box-header with-border">
									<h3 class="box-title">
										...
										<c:if test="${crudMode == 4}">
											<bean:message key="labels.boost_document_rule_link_confirm" />
										</c:if>
									</h3>
								...
								<div class="box-body">
									...
									<table class="table table-bordered">
										<tbody>
											<tr>
												<th class="col-xs-2"><bean:message key="labels.boost_document_rule_url_expr" /></th>
												<td>${f:h(urlExpr)}<html:hidden property="urlExpr" /></td>
											</tr>
											<tr>
												<th><bean:message key="labels.boost_document_rule_boost_expr" /></th>
								...
								<div class="box-footer">
									<c:if test="${crudMode == 1}">
										<input type="submit" class="btn" name="editagain" value="<bean:message key="labels.boost_document_rule_button_back"/>" />
