<%@page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><tiles:insert template="/WEB-INF/view/common/admin/layout.jsp" flush="true">
	<tiles:put name="title"><bean:message key="labels.boost_document_rule_configuration" /></tiles:put>
...
<html:errors/>
<br>
<s:link href="index"><bean:message key="labels.boost_document_rule_button_back"/></s:link>
</div>
