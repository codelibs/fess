                        ...
                        <div class="fads-card-body">
                            ...
                            <la:form action="/admin/failureurl/">
                                <div class="fads-form-field">
                                    ...
                                    <div class="col-sm-10">
                                        <la:text styleId="url" property="url" styleClass="fads-textfield"></la:text>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                    ...
                                    <div class="form-inline col-sm-10">
                                        <div>
                                            ...
                                            <input type="number" name="errorCountMin" id="errorCountMin"
                                                   value="${f:h(errorCountMin)}" class="fads-textfield"
                                                   min="0" max="100000">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="errorCountMax" id="errorCountMax"
                                                   value="${f:h(errorCountMax)}" class="fads-textfield"
                                                   min="0" max="100000">
                                        </div>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                    ...
                                    <div class="col-sm-10">
                                        <la:text styleId="errorName" property="errorName"
                                                 styleClass="fads-textfield"></la:text>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                            ...
                            <div class="data-wrapper">
                                ...
                                <c:if test="${failureUrlPager.allRecordCount > 0}">
                                    <div class="fads-row">
                                        <div class="fads-col-sm-12">
                                            <table class="fads-table" aria-label="<la:message key="labels.failure_url_list" />">
                                                <thead>
                                                <tr>
