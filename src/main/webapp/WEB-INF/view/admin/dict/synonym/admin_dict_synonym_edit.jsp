...
<div class="wrapper">
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <c:if test="${crudMode == 2}">
                                <li class="breadcrumb-item active"><la:message
                                        key="labels.dict_synonym_link_edit"/></li>
                            </c:if>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            <la:form action="/admin/dict/synonym/" styleClass="form-horizontal">
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="outputs" class="col-sm-3 col-form-label"><la:message
