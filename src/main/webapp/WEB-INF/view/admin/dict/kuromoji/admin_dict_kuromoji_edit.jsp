                        ...
                        <div
                            ...
                            <div class="fads-card-body">
                                ...
                                <div class="fads-form-field">
                                    <label for="token" class="fads-label"><la:message
                                            key="labels.dict_kuromoji_token"/></label>
                                    <div class="fads-col-sm-9">
                                        <la:errors property="token"/>
                                        <la:text styleId="token" property="token" styleClass="fads-textfield"/>
                                    </div>
                                </div>
                                <div class="fads-form-field">
                                    <label for="segmentation" class="fads-label"><la:message
                                ...
                                <div class="fads-form-field">
                                    <label for="pos" class="fads-label"><la:message
                                            key="labels.dict_kuromoji_pos"/></label>
                                    <div class="fads-col-sm-9">
                                        <la:errors property="pos"/>
                                        <la:text styleId="pos" property="pos" styleClass="fads-textfield"/>
                                    </div>
                                </div>
                            </div>
