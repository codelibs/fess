		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><la:message key="labels.dict_nori_list_link" /></li>
				</ol>
			</section>
					...
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<%-- List --%>
								<c:if test="${noriPager.allRecordCount == 0}">
									<div class="row top10">
										<div class="col-sm-12">
								...
								<c:if test="${noriPager.allRecordCount > 0}">
											...
											<table class="table table-bordered table-striped">
												...
												<tbody>
													<c:forEach var="data" varStatus="s"
														items="${noriItemItems}">
														<tr
															data-href="${contextPath}/admin/dict/nori/details/${f:u(dictId)}/4/${f:u(data.id)}">
									...
									<c:set var="pager" value="${noriPager}" scope="request" />
									<div class="row">
										<div class="col-sm-2">
