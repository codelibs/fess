    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <la:form action="/admin/searchlist/">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline <c:if test="${crudMode == 1}">card-success</c:if><c:if test="${crudMode == 2}">card-warning</c:if>">
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${crudMode==2}">
                                    <div class="form-group row">
                                        <label for="doc_id" class="col-sm-3 col-form-label">_id</label>
                                        <div class="col-sm-9">${f:h(id)}</div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="doc_id" class="col-sm-3 col-form-label">doc_id</label>
                                        <div class="col-sm-9">
                                                ${f:h(doc.doc_id)}
                                ...
                                <div class="form-group row">
                                    <label for="boost" class="col-sm-3 col-form-label">boost</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="lang" class="col-sm-3 col-form-label">lang</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="mimetype" class="col-sm-3 col-form-label">mimetype</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="has_cache" class="col-sm-3 col-form-label">has_cache</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="cache" class="col-sm-3 col-form-label">cache</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="digest" class="col-sm-3 col-form-label">digest</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="config_id" class="col-sm-3 col-form-label">config_id</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="content_length" class="col-sm-3 col-form-label">content_length</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="favorite_count" class="col-sm-3 col-form-label">favorite_count</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="click_count" class="col-sm-3 col-form-label">click_count</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="timestamp" class="col-sm-3 col-form-label">timestamp</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="last_modified" class="col-sm-3 col-form-label">last_modified</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="expires" class="col-sm-3 col-form-label">expires</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="virtual_host" class="col-sm-3 col-form-label">virtual_host</label>
                                    <div class="col-sm-9">
