...
<aside class="main-sidebar">
	...
	<div class="sidebar">
		...
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
			...
			<li class="nav-item has-treeview menu-open">
				<a href="#" class="nav-link <c:if test="${param.menuCategoryType=='crawl'}">active</c:if>"><em class='fa fa-laptop'></em> <span><la:message
			...
			<li class="nav-item has-treeview menu-open">
				<a href="#" class="nav-link <c:if test="${param.menuCategoryType=='user'}">active</c:if>"><em class='fa fa-laptop'></em> <span><la:message
			...
			<li class="nav-item has-treeview menu-open">
				<a href="#" class="nav-link <c:if test="${param.menuCategoryType=='suggest'}">active</c:if>"><em class='fa fa-laptop'></em> <span><la:message
			...
			<li class="nav-item has-treeview menu-open">
				<a href="#" class="nav-link <c:if test="${param.menuCategoryType=='log'}">active</c:if>"><em class='fa fa-laptop'></em> <span><la:message
