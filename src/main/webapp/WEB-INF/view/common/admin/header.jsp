...
<nav class="main-header navbar navbar-expand navbar-dark navbar-secondary">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="left"
			title="<la:message key="labels.tooltip_search_view" />"><a class="nav-link" href="${contextPath}/"><i class="fa fa-list-alt" aria-hidden="true"></i></a></li>
		<c:if test="${fe:permission('admin-scheduler')}">
			<li class="nav-item" data-toggle="tooltip" data-placement="left"
				title="<la:message key="labels.tooltip_run_crawler" />"><a class="nav-link"
									 href="${contextPath}/admin/scheduler/details/4/default_crawler"><i class="fa fa-play-circle" aria-hidden="true"></i></a></li>
		</c:if>
		<c:if test="${not empty forumLink}">
			<li class="nav-item" data-toggle="tooltip" data-placement="left"
				title="<la:message key="labels.tooltip_forum" />"><a class="nav-link" href="${forumLink}" target="_forum"><i class="fas fa-comments" aria-hidden="true"></i></a></li>
		</c:if>
		<c:if test="${not empty helpLink}">
			<li class="nav-item" data-toggle="tooltip" data-placement="left"
				title="<la:message key="labels.tooltip_onlinehelp" />"><a class="nav-link" href="${helpLink}" target="_olh"><i class="fa fa-question-circle" aria-hidden="true"></i></a></li>
		</c:if>
		<li class="nav-item" data-toggle="tooltip" data-placement="left"
