...
public class BsCrawlingSessionCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;CrawlingSessionCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;CrawlingSessionCB&gt;() {
     *     public void query(CrawlingSessionCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedCrawlingSessionInfoList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;CrawlingSessionInfoCB&gt;() {
         *     public void query(CrawlingSessionInfoCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, CrawlingSessionInfo.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
            ...
            return new HpSDRFunction<CrawlingSessionInfoCB, CrawlingSessionCQ>(
                    ...
                    new HpSDRSetupper<CrawlingSessionInfoCB, CrawlingSessionCQ>() {
                        ...
                        public void setup(final String function,
                                ...
                                final CrawlingSessionCQ cq,
                                final String aliasName,
                                final DerivedReferrerOption option) {
                            cq.xsderiveCrawlingSessionInfoList(function,
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;CrawlingSessionCB&gt;() {
    ...
    public HpColQyOperand<CrawlingSessionCB> columnQuery(
        ...
        return new HpColQyOperand<CrawlingSessionCB>(
                new HpColQyHandler<CrawlingSessionCB>() {
                    @Override
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;CrawlingSessionCB&gt;() {
     ...
     *     public void query(CrawlingSessionCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;CrawlingSessionCB&gt;() {
