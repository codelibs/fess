...
public class BsScheduledJobCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;ScheduledJobCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;ScheduledJobCB&gt;() {
     *     public void query(ScheduledJobCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;ScheduledJobCB&gt;() {
    ...
    public HpColQyOperand<ScheduledJobCB> columnQuery(
        ...
        return new HpColQyOperand<ScheduledJobCB>(
                new HpColQyHandler<ScheduledJobCB>() {
                    @Override
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;ScheduledJobCB&gt;() {
     ...
     *     public void query(ScheduledJobCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;ScheduledJobCB&gt;() {
