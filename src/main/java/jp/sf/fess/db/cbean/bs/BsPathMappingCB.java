...
public class BsPathMappingCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;PathMappingCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;PathMappingCB&gt;() {
     *     public void query(PathMappingCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
            ...
            return new HpSDRFunction<PathMappingCB, PathMappingCQ>(_baseCB,
                    ...
                    new HpSDRSetupper<PathMappingCB, PathMappingCQ>() {
                        ...
                        public void setup(final String function,
                                ...
                                final PathMappingCQ cq, final String aliasName,
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;PathMappingCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;PathMappingCB&gt;() {
     ...
     *     public void query(PathMappingCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;PathMappingCB&gt;() {
