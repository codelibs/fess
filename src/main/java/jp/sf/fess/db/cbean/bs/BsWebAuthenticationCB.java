...
public class BsWebAuthenticationCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WebAuthenticationCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WebAuthenticationCB&gt;() {
     *     public void query(WebAuthenticationCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = webAuthentication.<span style="color: #FD4747">getWebCrawlingConfig()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WebAuthenticationCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WebAuthenticationCB&gt;() {
     ...
     *     public void query(WebAuthenticationCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WebAuthenticationCB&gt;() {
