...
public class BsDataConfigToLabelTypeMappingCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;DataConfigToLabelTypeMappingCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;DataConfigToLabelTypeMappingCB&gt;() {
     *     public void query(DataConfigToLabelTypeMappingCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = dataConfigToLabelTypeMapping.<span style="color: #FD4747">getDataCrawlingConfig()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * DataConfigToLabelTypeMapping dataConfigToLabelTypeMapping = dataConfigToLabelTypeMappingBhv.selectEntityWithDeletedCheck(cb);
     * ... = dataConfigToLabelTypeMapping.<span style="color: #FD4747">getLabelType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;DataConfigToLabelTypeMappingCB&gt;() {
    ...
    public HpColQyOperand<DataConfigToLabelTypeMappingCB> columnQuery(
        ...
        return new HpColQyOperand<DataConfigToLabelTypeMappingCB>(
                new HpColQyHandler<DataConfigToLabelTypeMappingCB>() {
                    @Override
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;DataConfigToLabelTypeMappingCB&gt;() {
     ...
     *     public void query(DataConfigToLabelTypeMappingCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;DataConfigToLabelTypeMappingCB&gt;() {
