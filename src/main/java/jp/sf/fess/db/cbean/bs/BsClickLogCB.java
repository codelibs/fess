...
public class BsClickLogCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;ClickLogCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;ClickLogCB&gt;() {
     *     public void query(ClickLogCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * ... = clickLog.<span style="color: #FD4747">getSearchLog()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
            ...
            return new HpSDRFunction<ClickLogCB, ClickLogCQ>(_baseCB,
                    _qyCall.qy(), new HpSDRSetupper<ClickLogCB, ClickLogCQ>() {
                        ...
                        public void setup(final String function,
                                ...
                                final ClickLogCQ cq, final String aliasName,
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;ClickLogCB&gt;() {
    ...
    public HpColQyOperand<ClickLogCB> columnQuery(
        ...
        return new HpColQyOperand<ClickLogCB>(new HpColQyHandler<ClickLogCB>() {
            @Override
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;ClickLogCB&gt;() {
     ...
     *     public void query(ClickLogCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;ClickLogCB&gt;() {
