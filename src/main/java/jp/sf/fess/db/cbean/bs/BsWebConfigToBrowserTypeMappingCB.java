...
/**
 * The base condition-bean of WEB_CONFIG_TO_BROWSER_TYPE_MAPPING.
 * @author DBFlute(AutoGenerator)
 */
public class BsWebConfigToBrowserTypeMappingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WebConfigToBrowserTypeMappingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWebConfigToBrowserTypeMappingCB() {
    ...
    public void acceptPrimaryKey(final Long id) {
        ...
        final BsWebConfigToBrowserTypeMappingCB cb = this;
     ...
     */
    public WebConfigToBrowserTypeMappingCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public WebConfigToBrowserTypeMappingCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected WebConfigToBrowserTypeMappingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause()
                .getBasePointAliasName(), 0);
    }

    protected WebConfigToBrowserTypeMappingCQ xcreateCQ(
            final ConditionQuery childQuery, final SqlClause sqlClause,
            final String aliasName, final int nestLevel) {
        final WebConfigToBrowserTypeMappingCQ cq = xnewCQ(childQuery,
                sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WebConfigToBrowserTypeMappingCQ xnewCQ(
            final ConditionQuery childQuery, final SqlClause sqlClause,
            final String aliasName, final int nestLevel) {
        return new WebConfigToBrowserTypeMappingCQ(childQuery, sqlClause,
                aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *     public void query(WebConfigToBrowserTypeMappingCB unionCB) {
     ...
     */
    public void union(
            final UnionQuery<WebConfigToBrowserTypeMappingCB> unionQuery) {
        final WebConfigToBrowserTypeMappingCB cb = new WebConfigToBrowserTypeMappingCB();
        cb.xsetupForUnion(this);
        xsyncUQ(cb);
        unionQuery.query(cb);
        xsaveUCB(cb);
        final WebConfigToBrowserTypeMappingCQ cq = cb.query();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *     public void query(WebConfigToBrowserTypeMappingCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * WebConfigToBrowserTypeMapping webConfigToBrowserTypeMapping = webConfigToBrowserTypeMappingBhv.selectEntityWithDeletedCheck(cb);
     * ... = webConfigToBrowserTypeMapping.<span style="color: #FD4747">getWebCrawlingConfig()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * WebConfigToBrowserTypeMapping webConfigToBrowserTypeMapping = webConfigToBrowserTypeMappingBhv.selectEntityWithDeletedCheck(cb);
     * ... = webConfigToBrowserTypeMapping.<span style="color: #FD4747">getBrowserType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) {
            _specification = new HpSpecification(this,
                    new HpSpQyCall<WebConfigToBrowserTypeMappingCQ>() {
                        @Override
                        public boolean has() {
                            return true;
                        }
                        ...
                        @Override
                        public WebConfigToBrowserTypeMappingCQ qy() {
                            return getConditionQuery();
                        }
    ...
    public static class HpSpecification extends
            HpAbstractSpecification<WebConfigToBrowserTypeMappingCQ> {
        ...
        public HpSpecification(final ConditionBean baseCB,
                final HpSpQyCall<WebConfigToBrowserTypeMappingCQ> qyCall,
         ...
         */
        public HpSDRFunction<WebConfigToBrowserTypeMappingCB, WebConfigToBrowserTypeMappingCQ> myselfDerived() {
            assertDerived("myselfDerived");
            if (xhasSyncQyCall()) {
                xsyncQyCall().qy();
            } // for sync (for example, this in ColumnQuery)
            return new HpSDRFunction<WebConfigToBrowserTypeMappingCB, WebConfigToBrowserTypeMappingCQ>(
                    _baseCB,
                    _qyCall.qy(),
                    new HpSDRSetupper<WebConfigToBrowserTypeMappingCB, WebConfigToBrowserTypeMappingCQ>() {
                        @Override
                        public void setup(
                                final String function,
                                final SubQuery<WebConfigToBrowserTypeMappingCB> subQuery,
                                final WebConfigToBrowserTypeMappingCQ cq,
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *     public void query(WebConfigToBrowserTypeMappingCB cb) {
     *         cb.specify().<span style="color: #FD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *     public void query(WebConfigToBrowserTypeMappingCB cb) {
     ...
     */
    public HpColQyOperand<WebConfigToBrowserTypeMappingCB> columnQuery(
            final SpecifyQuery<WebConfigToBrowserTypeMappingCB> leftSpecifyQuery) {
        return new HpColQyOperand<WebConfigToBrowserTypeMappingCB>(
                new HpColQyHandler<WebConfigToBrowserTypeMappingCB>() {
                    @Override
                    public HpCalculator handle(
                            final SpecifyQuery<WebConfigToBrowserTypeMappingCB> rightSp,
    ...
    protected WebConfigToBrowserTypeMappingCB xcreateColumnQueryCB() {
        final WebConfigToBrowserTypeMappingCB cb = new WebConfigToBrowserTypeMappingCB();
     ...
     */
    public WebConfigToBrowserTypeMappingCB dreamCruiseCB() {
        final WebConfigToBrowserTypeMappingCB cb = new WebConfigToBrowserTypeMappingCB();
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *     public void query(WebConfigToBrowserTypeMappingCB orCB) {
    ...
    public void orScopeQuery(
            final OrQuery<WebConfigToBrowserTypeMappingCB> orQuery) {
        xorSQ((WebConfigToBrowserTypeMappingCB) this, orQuery);
    }
     ...
     *     public void query(WebConfigToBrowserTypeMappingCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;WebConfigToBrowserTypeMappingCB&gt;() {
     *             public void query(WebConfigToBrowserTypeMappingCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
    ...
    public void orScopeQueryAndPart(
            final AndQuery<WebConfigToBrowserTypeMappingCB> andQuery) {
        xorSQAP((WebConfigToBrowserTypeMappingCB) this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(final ConditionBean mainCB) {
        ...
        if (mainCB != null) {
            cb = (WebConfigToBrowserTypeMappingCB) mainCB;
        } else {
            cb = new WebConfigToBrowserTypeMappingCB();
        }
