...
public class ClickUrlRankingDbm extends AbstractDBMeta {
    ...
    public static class EpgName implements PropertyGateway {
        ...
        public Object read(final Entity e) {
            return ((ClickUrlRanking) e).getName();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((ClickUrlRanking) e).setName((String) v);
        }
    }
    ...
    public static class EpgCnt implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((ClickUrlRanking) e).getCnt();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((ClickUrlRanking) e).setCnt(ctl(v));
        }
    }
    ...
    public void acceptPrimaryKeyMap(final Entity e,
        ...
        doAcceptPrimaryKeyMap((ClickUrlRanking) e, m);
    }

    @Override
    public void acceptAllColumnMap(final Entity e,
            final Map<String, ? extends Object> m) {
        doAcceptAllColumnMap((ClickUrlRanking) e, m);
    }
