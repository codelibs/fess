...
public class DataConfigToLabelTypeMappingDbm extends AbstractDBMeta {
    ...
    public static class EpgId implements PropertyGateway {
        ...
        public Object read(final Entity e) {
            return ((DataConfigToLabelTypeMapping) e).getId();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((DataConfigToLabelTypeMapping) e).setId(ctl(v));
        }
    }
    ...
    public static class EpgDataConfigId implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((DataConfigToLabelTypeMapping) e).getDataConfigId();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((DataConfigToLabelTypeMapping) e).setDataConfigId(ctl(v));
        }
    }
    ...
    public static class EpgLabelTypeId implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((DataConfigToLabelTypeMapping) e).getLabelTypeId();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((DataConfigToLabelTypeMapping) e).setLabelTypeId(ctl(v));
        }
    }
    ...
    protected final ColumnInfo _columnId = cci(
            ...
            19,
            0,
            "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_C30E56CB_FCFB_46D4_A020_4F516E2C106A",
    ...
    public ForeignInfo foreignLabelType() {
        ...
        return cfi("CONSTRAINT_5CE1", "labelType", this,
                LabelTypeDbm.getInstance(), map, 1, false, false, false, false,
                null, null, false, "dataConfigToLabelTypeMappingList");
    }
    ...
    public void acceptPrimaryKeyMap(final Entity e,
        ...
        doAcceptPrimaryKeyMap((DataConfigToLabelTypeMapping) e, m);
    }

    @Override
    public void acceptAllColumnMap(final Entity e,
            final Map<String, ? extends Object> m) {
        doAcceptAllColumnMap((DataConfigToLabelTypeMapping) e, m);
    }
