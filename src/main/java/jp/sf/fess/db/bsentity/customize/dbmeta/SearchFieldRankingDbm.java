...
public class SearchFieldRankingDbm extends AbstractDBMeta {
    ...
    public static class EpgName implements PropertyGateway {
        ...
        public Object read(final Entity e) {
            return ((SearchFieldRanking) e).getName();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((SearchFieldRanking) e).setName((String) v);
        }
    }
    ...
    public static class EpgCnt implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((SearchFieldRanking) e).getCnt();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((SearchFieldRanking) e).setCnt(ctl(v));
        }
    }
    ...
    public void acceptPrimaryKeyMap(final Entity e,
        ...
        doAcceptPrimaryKeyMap((SearchFieldRanking) e, m);
    }

    @Override
    public void acceptAllColumnMap(final Entity e,
            final Map<String, ? extends Object> m) {
        doAcceptAllColumnMap((SearchFieldRanking) e, m);
    }
