...
public class FavoriteUrlRankingDbm extends AbstractDBMeta {
    ...
    public static class EpgName implements PropertyGateway {
        ...
        public Object read(final Entity e) {
            return ((FavoriteUrlRanking) e).getName();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((FavoriteUrlRanking) e).setName((String) v);
        }
    }
    ...
    public static class EpgCnt implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((FavoriteUrlRanking) e).getCnt();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((FavoriteUrlRanking) e).setCnt(ctl(v));
        }
    }
    ...
    protected final ColumnInfo _columnName = cci("NAME", "NAME", null, null,
            false, "name", String.class, false, false, "VARCHAR", 4000, 0,
    ...
    public void acceptPrimaryKeyMap(final Entity e,
        ...
        doAcceptPrimaryKeyMap((FavoriteUrlRanking) e, m);
    }

    @Override
    public void acceptAllColumnMap(final Entity e,
            final Map<String, ? extends Object> m) {
        doAcceptAllColumnMap((FavoriteUrlRanking) e, m);
    }
