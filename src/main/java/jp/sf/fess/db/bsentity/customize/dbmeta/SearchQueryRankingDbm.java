...
public class SearchQueryRankingDbm extends AbstractDBMeta {
    ...
    public static class EpgName implements PropertyGateway {
        ...
        public Object read(final Entity e) {
            return ((SearchQueryRanking) e).getName();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((SearchQueryRanking) e).setName((String) v);
        }
    }
    ...
    public static class EpgCnt implements PropertyGateway {
        @Override
        public Object read(final Entity e) {
            return ((SearchQueryRanking) e).getCnt();
        }

        @Override
        public void write(final Entity e, final Object v) {
            ((SearchQueryRanking) e).setCnt(ctl(v));
        }
    }
    ...
    public void acceptPrimaryKeyMap(final Entity e,
        ...
        doAcceptPrimaryKeyMap((SearchQueryRanking) e, m);
    }

    @Override
    public void acceptAllColumnMap(final Entity e,
            final Map<String, ? extends Object> m) {
        doAcceptAllColumnMap((SearchQueryRanking) e, m);
    }
