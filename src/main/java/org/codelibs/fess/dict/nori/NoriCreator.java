...
public class NoriCreator extends DictionaryCreator {
    private static final Logger logger = LoggerFactory.getLogger(NoriCreator.class);
    ...
    protected DictionaryFile<? extends DictionaryItem> newDictionaryFile(final String id, final String path, final Date timestamp) {
        return new NoriFile(id, path, timestamp).manager(dictionaryManager);
    }
