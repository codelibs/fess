...
public class SearchApiManager extends BaseApiManager {
    ...
    protected static class RequestParameter extends SearchRequestParams {
        ...
        @Override
        public GeoInfo getGeoInfo() {
            throw new UnsupportedOperationException("getGeoInfo() is not supported for suggest search requests");
        }

        @Override
        public FacetInfo getFacetInfo() {
            throw new UnsupportedOperationException("getFacetInfo() is not supported for suggest search requests");
        }

        @Override
        public String getSort() {
            throw new UnsupportedOperationException("getSort() is not supported for suggest search requests");
        }

        @Override
        public int getStartPosition() {
            throw new UnsupportedOperationException("getStartPosition() is not supported for suggest search requests");
        }

        @Override
        public int getOffset() {
            throw new UnsupportedOperationException("getOffset() is not supported for suggest search requests");
        }

        @Override
        public int getPageSize() {
            throw new UnsupportedOperationException("getPageSize() is not supported for suggest search requests");
        }

        @Override
        public String[] getExtraQueries() {
            throw new UnsupportedOperationException("getExtraQueries() is not supported for suggest search requests");
        }

        @Override
        public Object getAttribute(final String name) {
            throw new UnsupportedOperationException("getAttribute() is not supported for suggest search requests");
        }

        @Override
        public Locale getLocale() {
            throw new UnsupportedOperationException("getLocale() is not supported for suggest search requests");
        }
        ...
        @Override
        public String getSimilarDocHash() {
            throw new UnsupportedOperationException("getSimilarDocHash() is not supported for suggest search requests");
        }
