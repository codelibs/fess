...
public class AdminUpgradeAction extends FessAdminAction {
    ...
    private static final String VERSION_14_13 = "14.13";
    ...
    public HtmlResponse upgradeFrom(final UpgradeForm form) {
        ...
        } else if (VERSION_14_18.equals(form.targetVersion)) {
            try {
                upgradeFrom14_18();
                upgradeFromAll();
    ...
    private void upgradeFrom14_13() {
        // nothing
    }

    private void upgradeFrom14_14() {
        // nothing
    }
