 ...
 * @author FreeGen
 */
public abstract class BsLabelTypeCQ extends AbstractConditionQuery {
    ...
    public void filtered(FilteredCall<LabelTypeCQ> filteredLambda) {
        filtered(filteredLambda, null);
    }

    public void filtered(FilteredCall<LabelTypeCQ> filteredLambda, ConditionOptionCall<FilteredQueryBuilder> opLambda) {
