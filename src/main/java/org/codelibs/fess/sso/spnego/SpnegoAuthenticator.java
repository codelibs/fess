...
public class SpnegoAuthenticator implements SsoAuthenticator {
    ...
    protected static class SpnegoConfig implements FilterConfig {
        ...
        public ServletContext getServletContext() {
            throw new UnsupportedOperationException("getServletContext() is not supported in SPNEGO filter configuration");
        }
        ...
        public Enumeration<String> getInitParameterNames() {
            throw new UnsupportedOperationException("getInitParameterNames() is not supported in SPNEGO filter configuration");
        }
