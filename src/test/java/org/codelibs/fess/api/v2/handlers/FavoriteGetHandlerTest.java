...
public class FavoriteGetHandlerTest extends UnitFessTestCase {

    @Test
    public void test_favorite_methodGate_rejectsPost() throws Exception {
    ...
    @Test
    public void test_favorite_rejectsBlankDocId() throws Exception {
        final FavoriteGetHandler handler = new FavoriteGetHandler();
        final CapturingResponse res = new CapturingResponse();
        handler.handle(new StubRequest("/api/v2/documents//favorite"), res, "");
    ...
    @Test
    public void test_favorite_rejectsPathTraversalDocId() throws Exception {
        final FavoriteGetHandler handler = new FavoriteGetHandler();
        final CapturingResponse res = new CapturingResponse();
        handler.handle(new StubRequest("/api/v2/documents/..%2Fetc/favorite"), res, "../etc");
        assertEquals(400, res.status);
        final String body = res.body();
        assertTrue(body.contains("\"code\":\"invalid_request\""), body);
        assertTrue(body.contains("invalid doc_id"), body);
    ...
    @Test
    public void test_favorite_rejectsDocIdWithSpaces() throws Exception {
        final FavoriteGetHandler handler = new FavoriteGetHandler();
        final CapturingResponse res = new CapturingResponse();
        handler.handle(new StubRequest("/api/v2/documents/has spaces/favorite"), res, "has spaces");
        assertEquals(400, res.status);
        final String body = res.body();
        assertTrue(body.contains("\"code\":\"invalid_request\""), body);
    }
    ...
    @Test
    public void test_favorite_validDocIdShapeReachesBackend() throws Exception {
        final FavoriteGetHandler handler = new FavoriteGetHandler();
        final CapturingResponse res = new CapturingResponse();
        handler.handle(new StubRequest("/api/v2/documents/abc123/favorite"), res, "abc123");
        final String body = res.body();
        // The user-favorite flag defaults to off in fess_config — when off, the handler emits
