...
@Tag("it")
public class RelatedContentTests extends CrudTestBase {

    private static final String NAME_PREFIX = "relatedContentTest_";
    private static final String API_PATH = "/api/admin/relatedcontent";
